...
# Isto aqui você está fazendo localmente, não na máquina remota. A grande questão das últimas aulas foi aprender a usar
# o parâmetro user_data para executar scripts nas máquinas virtuais. Isso você demonstrou não compreender.
sudo su -
apt install apache2
echo “Acesse: HTTP://$IP/
